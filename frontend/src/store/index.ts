...
import { CategoriesStoreModule } from "./modules/categories-vuex.module"
...
export const store = createStore({
    state: {},
    modules: { TokenStoreModule, ProductsStoreModule, CartStoreModule, FilesStoreModule, CategoriesStoreModule }
})