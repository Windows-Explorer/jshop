    ...
    <transition name="sticky-header">
        <div class="sticky-header-container" v-if="show">
            <div class="sticky-header">
                ...
                <VRouteTab :to="{ path: '/coffee' }" label="Товары"
                ...
                <VRouteTab :to="{ path: '/cart' }" label="Корзина"
                    v-if="isAuthorized"
                ...
                <VRouteTab :to="{ path: '/signin' }" label="Аккаунт" v-if="!isAuthorized"
                ...
                <VRouteTab :to="{ path: '/account' }" label="Аккаунт" v-if="isAuthorized"
                    style="animation: jump-down 1.6s 1 cubic-bezier(0.6, 0.1, 0, 1.5);">
                    <template v-slot:icon>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                            <path
