                    ...
                    <div class="col-lg-2 col-md-6 col-8">
                        <div class="header-right-wrap">
                            <div class="same-style account-setting d-none d-lg-block">
                                <button class="account-setting-active" @click="isOpenAccountSettings = !isOpenAccountSettings"><i class="pe-7s-user"></i></button>
                                <div class="account-dropdown" :class="{ active:isOpenAccountSettings }">
                                    <ul>
                                        <li><n-link to="/login-register">Авторизация</n-link></li>
                                        <li><n-link to="/login-register">Регистрация</n-link></li>
                                        <li><n-link to="/my-account">Мой аккаунт</n-link></li>
                                    </ul>
                                </div>
                            </div>
