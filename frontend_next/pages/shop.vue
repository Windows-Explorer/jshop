                            ...
                            <div class="select-showing-wrap">
                                <div class="shop-select">
                                    <select v-model="selectedPrice">
                                        ...
                                        <option value="low2high">Сначала дешевые</option>
                                        <option value="high2low">Сначала дорогие</option>
                                    </select>
                                </div>
                                <p>Показано с {{perPage * currentPage - perPage + 1}} по {{perPage * currentPage > filterItems.length ? filterItems.length : perPage * currentPage}} из {{filterItems.length}}</p>
                            </div>
                            <div class="shop-tab">
