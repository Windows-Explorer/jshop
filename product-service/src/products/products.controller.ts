...
export class ProductsController {
    ...
    async findAll(@Payload() categoryName: string): Promise<IResult<IProduct[]>> {
        const result = await this._output.responseAsync(HttpStatus.OK, await this._productsService.findAll(categoryName))
        return result
    }
